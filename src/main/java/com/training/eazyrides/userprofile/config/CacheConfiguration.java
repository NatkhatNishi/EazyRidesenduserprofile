package com.training.eazyrides.userprofile.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("EazyRidesenduserprofile");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("EazyRidesenduserprofile");
        ...
        config.getMapConfigs().put("com.training.eazyrides.userprofile.domain.*", initializeDomainMapConfig(jHipsterProperties));
